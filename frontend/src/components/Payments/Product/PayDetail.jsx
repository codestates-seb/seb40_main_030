...
const PayDetail = () => {
  ...
  const setStateCart = useSetRecoilState(cartInfo);
  ...
  return (
    <S.PayLayout>
      <S.PayInformationLayout>
        ...
        <S.PayDetails>
          {state?.defaultPrice.toString().replace(PRICE_REGEX, ',')}원
        </S.PayDetails>
      </S.PayInformationLayout>
      <S.PayInformationLayout>
        <S.PayInformation>배터리 이용 금액</S.PayInformation>
        <S.PayDetails>
          + {state?.price.toString().replace(PRICE_REGEX, ',')}원
        </S.PayDetails>
      </S.PayInformationLayout>
      <S.PayDetailLayout>
        <S.PayInformationLayout>
          ...
          <S.TotalPayDetail>
            {totalAmount.toString().replace(PRICE_REGEX, ',')}원
          </S.TotalPayDetail>
        </S.PayInformationLayout>
      </S.PayDetailLayout>
