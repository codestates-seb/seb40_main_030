...
public class KakaoPayService {
    ...
    public KakaoPayReadyVO kakaoPayReady(String itemName, int totalAmount, Long paymentId) {
        ...
        params.add("approval_url", "http://localhost:8080/kakaoPaySuccess/" + paymentId);// 결제 승인시 url
        params.add("cancel_url", "http://localhost:8080/kakaoPayCancel/" + paymentId); // 결제 취소시 url
        params.add("fail_url", "http://localhost:8080/kakaoPaySuccessFail/" + paymentId); // 결제 실패시 url
